/**********************************************************************************
 *  TITLE: Blynk + Manual Button + IR + DHT11 control 4 Relays using NodeMCU (Real time feedback, WiFi control)
 *  Click on the following links to learn more. 
 *  YouTube Channel: https://youtube.com/@avelectrotech9853
 *  Preferences--> Aditional boards Manager URLs : 
 *  https://dl.espressif.com/dl/package_esp32_index.json, http://arduino.esp8266.com/stable/package_esp8266com_index.json
 *  
 *  Download Board ESP8266 NodeMCU (3.0.2): https://github.com/esp8266/Arduino
 *
